...
export default {
  ...
  methods: {
    valueChanged() {
      if (
        this.$refs.prefix.oldPrefix !== this.$refs.prefix.prefix ||
        this.$refs.lang.selected.value !== this.$refs.lang.oldSelected.value
      ) {
        if (!this.toastID) {
          ...
          console.log('payload===>>', payload, this.toastID)
