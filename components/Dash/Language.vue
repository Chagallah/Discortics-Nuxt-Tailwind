      ...
      <div class="px-8">
        ...
        <div class="py-2 flex flex-col lg:flex-row items-center mx-auto">
          ...
          <div v-else class="group relative">
            ...
            >
              ...
              <div
                id="dropdown-stuff"
                class="h-12 w-72 p-2 relative flex flex-col items-center"
              >
                <div
                  id="default-stuff"
                  :key="selected.name"
                  ...
                  >
                    ...
                    <div
                      :class="`text-gray-300 ml-auto${
                        lang.value == selected.value ? '' : ' invisible'
                      }`"
                    >
                      <SVGDropSelected />
                    </div>
        ...
        >
          <div class="h-8 py-3 flex flex-row items-center">
            <div class="h-8 w-24 exampleText text-xs rounded">
              <div class="animate-pulse m-2 p-2 h-2 bg-gray-600 rounded"></div>
            </div>
          </div>
          <div class="h-8 py-3 flex flex-row items-center">
            <div class="h-8 w-24 exampleText text-xs rounded">
